                          ...
                          <div className="flex items-center gap-1.5">
                            ...
                            {cancelItemConfirm === item.id ? (
                              <div className="flex items-center gap-1">
                                <button onClick={() => cancelOrderItem(order.id, item.id)} disabled={cancelItemLoading === item.id} className="text-xs font-bold text-white bg-red-500 hover:bg-red-600 px-1.5 py-0.5 rounded transition-colors disabled:opacity-50">
